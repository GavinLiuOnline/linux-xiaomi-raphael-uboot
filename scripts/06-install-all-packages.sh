...
BASE_PACKAGES="bash-completion sudo apt-utils ssh openssh-server nano gpgv gnupg gpgv2 grub2-common systemd network-manager initramfs-tools chrony curl wget locales tzdata iproute2 zram-tools"
